...
function getMessages(friend_id, message_id, table_id, table_container_id, type){
  ...
  $.ajax({
    ...
    url: "/mm306/socialNetwork/actions/getMessages.php",
...
function sendChatMessage(input_id, table_id, receiver_id, table_container_id){
  ...
  $.ajax({
    ...
    url: "/mm306/socialNetwork/actions/sendMessage.php",
    success: function(data){
      if(data >= 0){
...
function loadPosts(oldest_loaded){
  $.ajax({
    ...
    url: "/mm306/socialNetwork/actions/getPosts.php",
    success: function(data){
...
function writeComment(post_id, form){
  $.ajax({
    ...
    url: "/mm306/socialNetwork/actions/writeComment.php",
    success: function(data){
      form.comment.value = "";
...
function writeNewPost(form){
  $.ajax({
    ...
    url: "/mm306/socialNetwork/actions/writePost.php",
    success: function(data){
      if(data['success']==1){
...
function viewProfile(member_id){
  $.ajax({
    type: "GET",
    dataType: "JSON",
    url: "/mm306/socialNetwork/actions/viewProfile.php?id="+member_id,
    success: function(data){
      if(data['success'] == 1){
...
function loadPostsOfMember(member_id){
  $.ajax({
    ...
    url: "/mm306/socialNetwork/actions/getPostsOfMember.php",
    success: function(data){
      if(data['success'] == 1){
...
function removeFriend(id){
  $.ajax({
    type: "POST",
    url: "/mm306/socialNetwork/actions/removeFriend.php",
    data: {
      "friend_id" : id
    },
    success: function(data){
...
function searchFriend(form){
  $.ajax({
    type: "POST",
    url: "/mm306/socialNetwork/actions/searchFriend.php",
    dataType: "JSON",
    data: {
...
function inviteFriend(friend_id){
  $.ajax({
    type: "POST",
    url: "/mm306/socialNetwork/actions/requestFriendship.php",
    data: {
      "friend_id" : friend_id
    },
    success: function(data){
...
function cancelInvitation(friend_id){
  $.ajax({
    type: "POST",
    url: "/mm306/socialNetwork/actions/cancelFriendshipRequest.php",
    data: {
      "friend_id" : friend_id
    },
    success: function(){
...
function confirmFriendship(friend_id){
  $.ajax({
    type: "POST",
    url: "/mm306/socialNetwork/actions/confirmFriendship.php",
    data: {
      "friend_id" : friend_id
    },
    success: function(){
...
function uploadImage(){
  ...
  if(file){
    ...
    reader.onload = function(e){
      $.ajax({
        type: "POST",
        url: "/mm306/socialNetwork/actions/uploadImage.php",
        data: {
